...
import { Fingerprint, Home, Map, Zap } from "lucide-react";
...
export function AppNav() {
  ...
  return (
    ...
    >
      ...
      */}
      <div className="absolute bottom-0 left-0 hidden h-px w-full bg-linear-to-r from-transparent via-(--mode-color,transparent) to-transparent opacity-50 md:block" />
